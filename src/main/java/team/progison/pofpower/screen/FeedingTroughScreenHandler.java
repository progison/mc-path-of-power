package team.progison.pofpower.screen;
...
public class FeedingTroughScreenHandler extends ScreenHandler {
    ...
    public FeedingTroughScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory) {
        super(ModScreens.FEEDING_TROUGH_SCREEN_HANDLER, syncId);
        checkSize(inventory, 1);
        this.inventory = inventory;
        inventory.onOpen(playerInventory.player);
        this.addSlot(new FeedSlot(inventory, 0, 80, 26));
    ...
    static class FeedSlot extends Slot {
        public FeedSlot(Inventory inventory, int i, int j, int k) {
